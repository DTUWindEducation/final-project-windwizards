...
def test_calculate_angular_velocity():
    ...
    mock_op_chars = OperationalCharacteristics(
        characteristics=[
            OperationalCharacteristic(wind_speed=5.0, pitch=0.0, rpm=6.0, aero_power=1000, aero_thrust=2000),
            OperationalCharacteristic(wind_speed=10.0, pitch=2.0, rpm=8.0, aero_power=1500, aero_thrust=2500),
            OperationalCharacteristic(wind_speed=15.0, pitch=4.0, rpm=10.0, aero_power=2000, aero_thrust=3000),
        ]
    )
