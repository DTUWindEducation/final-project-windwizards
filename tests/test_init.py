...
def test_save_results():
    ...
    results = (1000.0, 2000.0, 50000.0, 0.75, 0.45)  # thrust, torque, power, ct, cp
...
def test_save_plots(mock_close, mock_savefig):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i, call_args in enumerate(mock_savefig.call_args_list):
            ...
            assert filename == expected_filenames[i], f"Expected {expected_filenames[i]} but got {filename}"