...
def test_operational_characteristic_init():
    ...
    characteristic = OperationalCharacteristic(
        wind_speed=10.0, pitch=2.0, rpm=8.0, aero_power=1500, aero_thrust=2500
    )
...
def test_operational_characteristic_repr():
    ...
    characteristic = OperationalCharacteristic(
        wind_speed=12.0, pitch=3.0, rpm=9.0, aero_power=1800, aero_thrust=2800
    )
...
def test_operational_characteristics_init():
    ...
    char2 = OperationalCharacteristic(
        wind_speed=15.0, pitch=4.0, rpm=10.0, aero_power=2000, aero_thrust=3000
    )
...
def test_plot_characteristics(
    ...
    # Create test data
    char1 = OperationalCharacteristic(
        wind_speed=5.0, pitch=1.0, rpm=6.0, aero_power=1000, aero_thrust=2000
    )
    char2 = OperationalCharacteristic(
        wind_speed=10.0, pitch=2.0, rpm=8.0, aero_power=1500, aero_thrust=2500
    )
    char3 = OperationalCharacteristic(
        wind_speed=15.0, pitch=3.0, rpm=10.0, aero_power=2000, aero_thrust=3000
    )
